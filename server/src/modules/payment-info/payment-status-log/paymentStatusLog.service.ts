...
class EmployeeService {
  ...
  async createMany(pMutableList: CreatePaymentStatusLogDto[]): Promise<PaymentStatusLogDto[]> {
  ...
  async updateMany(pMutableList: UpdatePaymentStatusLogDto[]): Promise<PaymentStatusLogDto[]> {
